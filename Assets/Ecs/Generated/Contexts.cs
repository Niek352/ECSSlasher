...
public partial class Contexts
{
	...
	{
		Game.AddEntityIndex(new JCMG.EntitasRedux.EntityIndex<GameEntity, byte>(
			CharacterId,
			Game.GetGroup(GameMatcher.CharacterId),
			(e, c) => ((Ecs.Game.Components.CharacterIdComponent)c).Id));
	}
}

public static class ContextsExtensions
{
	public static System.Collections.Generic.HashSet<GameEntity> GetEntitiesWithCharacterId(this GameContext context, byte Id)
	{
		return ((JCMG.EntitasRedux.EntityIndex<GameEntity, byte>)context.GetEntityIndex(Contexts.CharacterId)).GetEntities(Id);
	}
}
//------------------------------------------------------------------------------
// <auto-generated>
