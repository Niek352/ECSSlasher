...
public partial class GameEntity
{
	...
	public void CopyComponentTo(IComponent component)
	{
		...
		else if (component is Ecs.Game.Core.Components.VelocityComponent Velocity)
		{
			CopyVelocityTo(Velocity);
		}
		else if (component is Ecs.Game.Core.Components.RotationComponent Rotation)
		{
			CopyRotationTo(Rotation);
		}
		else if (component is Ecs.Game.Core.Components.LookDirectionComponent LookDirection)
		{
