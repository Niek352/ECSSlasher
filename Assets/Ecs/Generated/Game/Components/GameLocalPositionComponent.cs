...
{
	public Ecs.Game.Core.Components.LocalPositionComponent LocalPosition { get { return (Ecs.Game.Core.Components.LocalPositionComponent)GetComponent(GameComponentsLookup.LocalPosition); } }
	...
	public void AddLocalPosition(UnityEngine.Vector3 newValue)
	{
		...
		var component = (Ecs.Game.Core.Components.LocalPositionComponent)CreateComponent(index, typeof(Ecs.Game.Core.Components.LocalPositionComponent));
	...
	public void CopyLocalPositionTo(Ecs.Game.Core.Components.LocalPositionComponent copyComponent)
	{
		var index = GameComponentsLookup.LocalPosition;
		var component = (Ecs.Game.Core.Components.LocalPositionComponent)CreateComponent(index, typeof(Ecs.Game.Core.Components.LocalPositionComponent));
		#if !ENTITAS_REDUX_NO_IMPL
