...
{
	public Ecs.Game.Core.Components.VelocityComponent Velocity { get { return (Ecs.Game.Core.Components.VelocityComponent)GetComponent(GameComponentsLookup.Velocity); } }
	...
	public void AddVelocity(UnityEngine.Vector3 newValue)
	{
		...
		var component = (Ecs.Game.Core.Components.VelocityComponent)CreateComponent(index, typeof(Ecs.Game.Core.Components.VelocityComponent));
	...
	public void CopyVelocityTo(Ecs.Game.Core.Components.VelocityComponent copyComponent)
	{
		var index = GameComponentsLookup.Velocity;
		var component = (Ecs.Game.Core.Components.VelocityComponent)CreateComponent(index, typeof(Ecs.Game.Core.Components.VelocityComponent));
		#if !ENTITAS_REDUX_NO_IMPL
