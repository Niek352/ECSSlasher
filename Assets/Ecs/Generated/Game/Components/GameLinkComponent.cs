...
{
	public Ecs.Game.Core.Components.LinkComponent Link { get { return (Ecs.Game.Core.Components.LinkComponent)GetComponent(GameComponentsLookup.Link); } }
	...
	public void AddLink(Ecs.Views.Linkable.ILinkable newView)
	{
		...
		var component = (Ecs.Game.Core.Components.LinkComponent)CreateComponent(index, typeof(Ecs.Game.Core.Components.LinkComponent));
	...
	public void CopyLinkTo(Ecs.Game.Core.Components.LinkComponent copyComponent)
	{
		var index = GameComponentsLookup.Link;
		var component = (Ecs.Game.Core.Components.LinkComponent)CreateComponent(index, typeof(Ecs.Game.Core.Components.LinkComponent));
		#if !ENTITAS_REDUX_NO_IMPL
